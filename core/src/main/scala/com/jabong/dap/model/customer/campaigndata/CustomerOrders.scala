  ...
  def joinCustOrder(incr: DataFrame, prevFull: DataFrame): DataFrame = {
    ...
    if (null != prevFull) {
      ...
      val custOrdersFull = custOrdersIncr.join(custOrdersPrevFull, custOrdersIncr(SalesOrderVariables.FK_CUSTOMER) === custOrdersPrevFull(SalesOrderVariables.FK_CUSTOMER), SQL.FULL_OUTER)
        ...
        .select(coalesce(custOrdersIncr(SalesOrderVariables.FK_CUSTOMER), custOrdersPrevFull(SalesOrderVariables.FK_CUSTOMER)+"OLD") as SalesOrderVariables.FK_CUSTOMER,
          when(custOrdersIncr(SalesOrderVariables.MAX_ORDER_BASKET_VALUE) > custOrdersPrevFull(SalesOrderVariables.MAX_ORDER_BASKET_VALUE+"OLD"), custOrdersIncr(SalesOrderVariables.MAX_ORDER_BASKET_VALUE)).otherwise(custOrdersPrevFull(SalesOrderVariables.MAX_ORDER_BASKET_VALUE+"OLD")) as SalesOrderVariables.MAX_ORDER_BASKET_VALUE,
          when(custOrdersIncr(SalesOrderVariables.MAX_ORDER_ITEM_VALUE) > custOrdersPrevFull(SalesOrderVariables.MAX_ORDER_ITEM_VALUE+"OLD"), custOrdersIncr(SalesOrderVariables.MAX_ORDER_ITEM_VALUE)).otherwise(custOrdersPrevFull(SalesOrderVariables.MAX_ORDER_ITEM_VALUE+"OLD")) as SalesOrderVariables.MAX_ORDER_ITEM_VALUE,
          custOrdersIncr(SalesOrderVariables.SUM_BASKET_VALUE) + custOrdersPrevFull(SalesOrderVariables.SUM_BASKET_VALUE+"OLD") as SalesOrderVariables.SUM_BASKET_VALUE,
          custOrdersIncr(SalesOrderVariables.COUNT_BASKET_VALUE) + custOrdersPrevFull(SalesOrderVariables.COUNT_BASKET_VALUE+"OLD") as SalesOrderVariables.COUNT_BASKET_VALUE,
          custOrdersIncr(SalesOrderVariables.ORDER_ITEM_COUNT) + custOrdersPrevFull(SalesOrderVariables.ORDER_ITEM_COUNT+"OLD") as SalesOrderVariables.ORDER_ITEM_COUNT,
          coalesce(custOrdersIncr(SalesOrderVariables.LAST_ORDER_DATE), custOrdersPrevFull(SalesOrderVariables.LAST_ORDER_DATE+"OLD")) as SalesOrderVariables.LAST_ORDER_DATE,
          coalesce(custOrdersIncr(SalesAddressVariables.LAST_SHIPPING_CITY), custOrdersPrevFull(SalesAddressVariables.LAST_SHIPPING_CITY+"OLD")) as SalesAddressVariables.LAST_SHIPPING_CITY,
          coalesce(custOrdersIncr(SalesAddressVariables.LAST_SHIPPING_CITY_TIER), custOrdersPrevFull(SalesAddressVariables.LAST_SHIPPING_CITY_TIER+"OLD")) as SalesAddressVariables.LAST_SHIPPING_CITY_TIER,
          coalesce(custOrdersPrevFull(SalesAddressVariables.FIRST_SHIPPING_CITY+"OLD"), custOrdersIncr(SalesAddressVariables.FIRST_SHIPPING_CITY)) as SalesAddressVariables.FIRST_SHIPPING_CITY,
          coalesce(custOrdersPrevFull(SalesAddressVariables.FIRST_SHIPPING_CITY_TIER+"OLD"), custOrdersIncr(SalesAddressVariables.FIRST_SHIPPING_CITY_TIER)) as SalesAddressVariables.FIRST_SHIPPING_CITY_TIER,
          custOrdersPrevFull(SalesOrderItemVariables.COUNT_OF_INVLD_ORDERS+"OLD") + custOrdersIncr(SalesOrderItemVariables.COUNT_OF_INVLD_ORDERS) as SalesOrderItemVariables.COUNT_OF_INVLD_ORDERS,
          custOrdersPrevFull(SalesOrderItemVariables.COUNT_OF_CNCLD_ORDERS+"OLD") + custOrdersIncr(SalesOrderItemVariables.COUNT_OF_CNCLD_ORDERS) as SalesOrderItemVariables.COUNT_OF_CNCLD_ORDERS,
          custOrdersPrevFull(SalesOrderItemVariables.COUNT_OF_RET_ORDERS+"OLD") + custOrdersIncr(SalesOrderItemVariables.COUNT_OF_RET_ORDERS) as SalesOrderItemVariables.COUNT_OF_RET_ORDERS,
          custOrdersPrevFull(SalesOrderItemVariables.SUCCESSFUL_ORDERS+"OLD") + custOrdersIncr(SalesOrderItemVariables.SUCCESSFUL_ORDERS) as SalesOrderItemVariables.SUCCESSFUL_ORDERS,
          custOrdersPrevFull(SalesOrderItemVariables.GROSS_ORDERS+"OLD") + custOrdersIncr(SalesOrderItemVariables.GROSS_ORDERS) as SalesOrderItemVariables.GROSS_ORDERS,
          coalesce(custOrdersIncr(SalesOrderVariables.LAST_ORDER_UPDATED_AT), custOrdersPrevFull(SalesOrderVariables.LAST_ORDER_UPDATED_AT+"OLD")) as SalesOrderVariables.LAST_ORDER_UPDATED_AT,
          coalesce(custOrdersPrevFull(SalesOrderVariables.FIRST_ORDER_DATE+"OLD"), custOrdersIncr(SalesOrderVariables.FIRST_ORDER_DATE)) as SalesOrderVariables.FIRST_ORDER_DATE,
          when(custOrdersIncr(SalesRuleSetVariables.MIN_COUPON_VALUE_USED) < custOrdersPrevFull(SalesRuleSetVariables.MIN_COUPON_VALUE_USED+"OLD"), custOrdersIncr(SalesRuleSetVariables.MIN_COUPON_VALUE_USED)).otherwise(custOrdersPrevFull(SalesRuleSetVariables.MIN_COUPON_VALUE_USED+"OLD")) as SalesRuleSetVariables.MIN_COUPON_VALUE_USED,
          when(custOrdersIncr(SalesRuleSetVariables.MAX_COUPON_VALUE_USED) > custOrdersPrevFull(SalesRuleSetVariables.MAX_COUPON_VALUE_USED+"OLD"), custOrdersIncr(SalesRuleSetVariables.MAX_COUPON_VALUE_USED)).otherwise(custOrdersPrevFull(SalesRuleSetVariables.MAX_COUPON_VALUE_USED+"OLD")) as SalesRuleSetVariables.MAX_COUPON_VALUE_USED,
          custOrdersIncr(SalesRuleSetVariables.COUPON_SUM) + custOrdersPrevFull(SalesRuleSetVariables.COUPON_SUM+"OLD") as SalesRuleSetVariables.COUPON_SUM,
          custOrdersIncr(SalesRuleSetVariables.COUPON_COUNT) + custOrdersPrevFull(SalesRuleSetVariables.COUPON_COUNT+"OLD") as SalesRuleSetVariables.COUPON_COUNT,
          when(custOrdersIncr(SalesRuleSetVariables.MIN_DISCOUNT_USED) < custOrdersPrevFull(SalesRuleSetVariables.MIN_DISCOUNT_USED+"OLD"), custOrdersIncr(SalesRuleSetVariables.MIN_DISCOUNT_USED)).otherwise(custOrdersPrevFull(SalesRuleSetVariables.MIN_DISCOUNT_USED+"OLD")) as SalesRuleSetVariables.MIN_DISCOUNT_USED,
          when(custOrdersIncr(SalesRuleSetVariables.MAX_DISCOUNT_USED) < custOrdersPrevFull(SalesRuleSetVariables.MAX_DISCOUNT_USED+"OLD"), custOrdersIncr(SalesRuleSetVariables.MAX_DISCOUNT_USED)).otherwise(custOrdersPrevFull(SalesRuleSetVariables.MAX_DISCOUNT_USED+"OLD")) as SalesRuleSetVariables.MAX_DISCOUNT_USED,
          custOrdersIncr(SalesRuleSetVariables.DISCOUNT_SUM) + custOrdersPrevFull(SalesRuleSetVariables.DISCOUNT_SUM+"OLD") as SalesRuleSetVariables.DISCOUNT_SUM,
          custOrdersIncr(SalesRuleSetVariables.DISCOUNT_COUNT) + custOrdersPrevFull(SalesRuleSetVariables.DISCOUNT_COUNT+"OLD") as SalesRuleSetVariables.DISCOUNT_COUNT,
          coalesce(custOrdersIncr(SalesOrderItemVariables.REVENUE_7), custOrdersPrevFull(SalesOrderItemVariables.REVENUE_7+"OLD")) as SalesOrderItemVariables.REVENUE_7,
          coalesce(custOrdersIncr(SalesOrderItemVariables.REVENUE_30), custOrdersPrevFull(SalesOrderItemVariables.REVENUE_30+"OLD")) as SalesOrderItemVariables.REVENUE_30,
          coalesce(custOrdersIncr(SalesOrderItemVariables.REVENUE_LIFE), custOrdersPrevFull(SalesOrderItemVariables.REVENUE_LIFE+"OLD")) as SalesOrderItemVariables.REVENUE_LIFE,
          coalesce(custOrdersIncr(SalesOrderItemVariables.ORDERS_COUNT_LIFE), custOrdersPrevFull(SalesOrderItemVariables.ORDERS_COUNT_LIFE+"OLD")) as SalesOrderItemVariables.ORDERS_COUNT_LIFE,
          coalesce(custOrdersIncr(SalesOrderVariables.CATEGORY_PENETRATION), custOrdersPrevFull(SalesOrderVariables.CATEGORY_PENETRATION+"OLD")) as SalesOrderVariables.CATEGORY_PENETRATION,
          coalesce(custOrdersIncr(SalesOrderVariables.BRICK_PENETRATION), custOrdersPrevFull(SalesOrderVariables.BRICK_PENETRATION+"OLD")) as SalesOrderVariables.BRICK_PENETRATION,
          coalesce(custOrdersIncr(SalesOrderItemVariables.FAV_BRAND), custOrdersPrevFull(SalesOrderItemVariables.FAV_BRAND+"OLD")) as SalesOrderItemVariables.FAV_BRAND,
          coalesce(custOrdersIncr(ContactListMobileVars.CITY), custOrdersPrevFull(ContactListMobileVars.CITY+"OLD")) as ContactListMobileVars.CITY,
          coalesce(custOrdersIncr(CustomerVariables.PHONE), custOrdersPrevFull(CustomerVariables.PHONE+"OLD")) as CustomerVariables.PHONE,
          coalesce(custOrdersIncr(CustomerVariables.FIRST_NAME), custOrdersPrevFull(CustomerVariables.FIRST_NAME+"OLD")) as CustomerVariables.FIRST_NAME,
          coalesce(custOrdersIncr(CustomerVariables.LAST_NAME), custOrdersPrevFull(CustomerVariables.LAST_NAME+"OLD")) as CustomerVariables.LAST_NAME,
          coalesce(custOrdersIncr(ContactListMobileVars.CITY_TIER), custOrdersPrevFull(ContactListMobileVars.CITY_TIER+"OLD")) as ContactListMobileVars.CITY_TIER,
          coalesce(custOrdersIncr(ContactListMobileVars.STATE_ZONE), custOrdersPrevFull(ContactListMobileVars.STATE_ZONE+"OLD")) as ContactListMobileVars.STATE_ZONE
        )
      // This is being done as for decimal type columns the precision is becoming 20 and
      // while writing to parquet it is giving error
