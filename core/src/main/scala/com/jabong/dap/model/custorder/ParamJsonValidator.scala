...
object ParamJsonValidator {
  ...
  private def validatePossibleValues(paramInfo: ParamInfo) = {
    val possibleSourceFormats = Array(DataSets.AD4PUSH, DataSets.CUSTOMER_DEVICE_MAPPING, DataSets.BASIC_ITR, DataSets.PRICING, DataSets.DCF_FEED, DataSets.CAMPAIGN_QUALITY)
