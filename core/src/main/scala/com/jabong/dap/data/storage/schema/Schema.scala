...
object Schema {
  ...
  val finalReferenceSku = StructType(Array(
    ...
    StructField(CampaignMergedFields.REF_SKUS, ArrayType(StructType(Array(StructField(ProductVariables.SPECIAL_PRICE, DoubleType, true),StructField(ProductVariables.SKU, StringType, true),
