...
object Init {
  ...
  def run(params: Params) = {
    params.component match {
      ...
      case "emailCampaignMergeFeed" => CampaignManager.campaginMergeFeed(DataSets.EMAIL_CAMPAIGNS)
      case "calendarCampaignMerge" => CampaignManager.startCampaignMerge(params.campaignsJson, DataSets.CALENDAR_CAMPAIGNS)
      case "calendarCampaignMergeFeed" => CampaignManager.campaginMergeFeed(DataSets.CALENDAR_CAMPAIGNS)
