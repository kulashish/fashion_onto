...
"Zero value for special price " should "return price" in {
  ...
  val expectedPrice = BasicBob.correctPrice(specialPrice,price,null,null)
  ...
  "current date falls in between special price from date and to date " should "return special Price" in {
    ...
    val expectedPrice = BasicBob.correctPrice(specialPrice,price,yesterdayDate,nextDayDate)
