...
hadoop distcp -pb hdfs://172.16.84.37:8020$MergeDir/$LAST_YEAR/$LAST_MONTH/$LAST_DAY hdfs://dataplatform-master:8020/data/clickstream/merge/$LAST_YEAR/$LAST_MONTH
